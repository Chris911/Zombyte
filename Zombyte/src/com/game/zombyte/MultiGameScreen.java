...
public class MultiGameScreen extends GLScreen {
    ...
    public MultiGameScreen(Game game) {
        ...
        worldListener = new MultiWorldListener() {
        ...
        world = new MultiWorld(worldListener);
        
        // Create a renderer
        renderer = new MultiWorldRenderer(glGraphics, batcher, world);
...
//	    final float hubWeaponRatio = 50.0f; 
    ...
    public void handlePlayerActionJoystickEvents() {
    	...
    	if(actionStickIsMoving){
    		world.addMultiBullet(actionJoystick.getAngle());
